...
ifeq ($(uname_S),FreeBSD)
  ...
  DYLIB_MAKE_CMD = $(CC) $(OPTIMIZATION) $(SUN_SHARED_FLAG) -o $(DYLIBNAME) -h $(DYLIB_PATCH_NAME)
  TLS_DYLIB_MAKE_CMD = $(CC) $(SUN_SHARED_FLAG) -o $(TLS_DYLIBNAME) -h $(TLS_DYLIB_PATCH_NAME) $(TLS_LDFLAGS)
  ...
  DYLIB_MAKE_CMD=$(CC) -dynamiclib -Wl,-install_name,$(PREFIX)/$(LIBRARY_PATH)/$(DYLIB_PATCH_NAME) -o $(DYLIBNAME)
  ...
  TLS_DYLIB_MAKE_CMD=$(CC) -dynamiclib -Wl,-install_name,$(PREFIX)/$(LIBRARY_PATH)/$(TLS_DYLIB_PATCH_NAME) -o $(TLS_DYLIBNAME) $(TLS_LDFLAGS)
endif
...
$(TLS_DYLIBNAME): $(TLS_OBJS)
	$(TLS_DYLIB_MAKE_CMD) -o $(TLS_DYLIBNAME) $(TLS_OBJS) $(REAL_LDFLAGS) $(TLS_LDFLAGS)

$(TLS_STLIBNAME): $(TLS_OBJS)
	$(STLIB_MAKE_CMD) $(TLS_STLIBNAME) $(TLS_OBJS)

$(RDMA_DYLIBNAME): $(RDMA_OBJS)
	$(RDMA_DYLIB_MAKE_CMD) -o $(RDMA_DYLIBNAME) $(RDMA_OBJS) $(REAL_LDFLAGS) $(RDMA_LDFLAGS)
